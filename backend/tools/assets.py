...
def confirm_asset_extraction_complete(project_id: str) -> dict:
    ...
    # Readiness and advancement must agree; advancing cannot invent creative input.
    ...
    if missing:
        return {
            ...
            "message": "Prepare and review prompts before advancing: " + ", ".join(a["name"] for a in missing),
        }
