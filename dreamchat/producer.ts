...
- "leaves": what this moment changes in how someone, something or a place LOOKS, that later pictures must keep showing, as {"who": an id, "what": the part or attribute, "now": its new state}. For example, when someone's hair turns white: {"who": "p1", "what": "hair", "now": "white"}; when a room floods: {"who": "l1", "what": "water", "now": "up over the tops of the desks"}, and again where it rises further. Never where someone is or what they are doing (walking off, sitting down, being at the far end): only how they look. Empty when nothing about a look lasts.
